...
include "connection.php";
    ...
    $sql = "SELECT i.id, i.itemname, i.itemimage, i.itemprice, i.itemdesc, c.categoryname, a.itemstatus FROM assignitems a, branch b, category c, items i WHERE a.branchid=b.id AND a.catid=c.id AND a.itemid=i.id AND a.itemstatus='Available' AND a.branchid='$bid' AND a.catid='$cid' ";
